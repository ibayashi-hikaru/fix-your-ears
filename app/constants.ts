...
export const PERFECT_COMMENTS = [
  ...
  "Your ears are suspiciously good.",
  "Fine. You win this round.",
  "That was annoyingly perfect.",
  "I wasn't expecting that. At all.",
  "Okay, your hearing is intact. Barely.",
  "Perfect. Don't let it go to your head.",
  "You heard every single sound. How?",
  "I'm almost impressed. Almost.",
  "Well, well. Someone's been practicing.",
  "Flawless. I hate to admit it.",
  "Your ears earned a gold star today.",
  "Not a single mistake. Suspicious.",
  "I'll give you this one. Just this one.",
];
...
export const EXCELLENT_COMMENTS = [
  ...
  "One little slip. Typical.",
  "You were so close. So, so close.",
  "Almost perfect, but 'almost' isn't perfect.",
  "Your ears did okay. Just okay.",
  "Not bad. But I expected better.",
  "A tiny mistake. Could've been perfect.",
  "You almost impressed me. Almost.",
  "Close enough, I guess. For you.",
  "Your hearing is decent. Not great. Decent.",
  "That was acceptable. Barely.",
  "So near, yet so far.",
  "You were THIS close. But no.",
  "I'll give you a B-minus. Generous of me.",
  "One wrong sound and you crumble.",
  "Your ears got lazy at the end.",
];
...
export const GOOD_COMMENTS = [
  ...
  "Did you hear a completely different word?",
  "Your ears and my mouth disagree.",
  "I said it clearly. What happened?",
  "Were you distracted? Be honest.",
  "Your listening needs some serious work.",
  "That was mediocre at best.",
  "I'm not angry, just disappointed. In your ears.",
  "You heard... something. Not the right thing.",
  "Maybe listen harder next time?",
  "Your ears are on vacation, apparently.",
  "I'm concerned about your hearing.",
  "That's not even close to what I said.",
  "Were you listening through a wall?",
  "Half right. Half wrong. All disappointing.",
];
...
export const BAD_COMMENTS = [
  ...
  "Fix. Your. Ears.",
  "I can't even... what was that?",
  "Were you underwater while I was talking?",
  "That's impressively wrong.",
  "Did you have your fingers in your ears?",
  "I'm speechless. And not in a good way.",
  "Your ears need a factory reset.",
  "That was so wrong it's almost creative.",
  "Were you even in the same room?",
  "I don't think your ears are connected.",
  "Wow. Just... wow. Fix your ears.",
  "Did you fall asleep mid-sentence?",
  "Your hearing has left the building.",
  "That's not a word I said. Ever.",
...
export const FINAL_EXCELLENT_COMMENTS = [
  ...
  "Not bad overall. I'll allow it.",
  "Your ears passed the test. Barely.",
  "Decent hearing. Don't get cocky.",
  "I suppose your ears are functional.",
  "Better than I expected. Low bar though.",
  "Fine. You can hear. Congratulations.",
  "Your ears earned a passing grade.",
  "Acceptable performance. For a human.",
  "I'm reluctantly impressed.",
  "Your hearing is above average. Slightly.",
  "Well done. I hate saying that.",
  "You actually listened. Shocking.",
  "Your ears surprised me today.",
...
export const FINAL_GOOD_COMMENTS = [
  ...
  "Your ears tried. They failed, but they tried.",
  "Average. Painfully average.",
  "You need more ear training. Much more.",
  "Could be worse. Could be much better.",
  "Your hearing is a work in progress.",
  "I've seen worse. Not much worse, but worse.",
  "Your ears are underperforming.",
  "Middling results. How unsurprising.",
  "You heard some things right. Some.",
  "Not a disaster. Not a success either.",
  "Your ears did the bare minimum.",
  "Lukewarm results for lukewarm listening.",
  "You scraped by. Barely.",
  "Meh. That's all I have to say. Meh.",
];
...
export const FINAL_BAD_COMMENTS = [
  ...
  "I have no hope for your hearing.",
  "That was a disaster for your ears.",
  "Your listening skills are non-existent.",
  "I'm genuinely worried about you.",
  "Were you wearing earplugs the whole time?",
  "Your ears need professional help.",
  "That was historically bad.",
  "I've never seen ears fail this hard.",
  "Fix your ears. Then try again.",
  "Your hearing score is embarrassing.",
  "Did you play with your eyes closed AND ears?",
  "I can't believe what I just witnessed.",
  "Your ears owe me an apology.",
  "That was an insult to the English language.",
  "Please. For everyone's sake. Fix your ears.",
];
